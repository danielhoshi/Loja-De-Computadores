		...
		<div class="row" style="height: 700px">
			<div class="col-sm-9" id="tipos">
				...
				<a href="#"> <span class="col-sm-4 itemLista"> <img
						src="img/processador.jpg" class="img-thumbnail" /> <br> <span>
							Fabricante: <b><%=processador.getFabricante()%></b>
					</span> <br> <span> Modelo: <b><%=processador.getModelo()%></b>
					</span> <br> <span> Frequência: <b><%=processador.getFrequencia()%></b>
					</span> <br> <span> Soquete: <b><%=processador.getSoquete().getNome()%></b>
					</span> <br> <span> Preço: <b>R$<%=processador.getPrecoFormat()%></b>
					</span>
				</span>
				</a>
				<%
