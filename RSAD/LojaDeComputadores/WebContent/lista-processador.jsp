			...
			<div class="col-sm-9" id="tipos">
				...
				<%
					...
					if(listaProcessador == null){
						%>
						<span style="font-family: verdana">Não foram encontradas processadores</span>
						<%
					}
					else{ 
	...
	<div id="modalItem" class="modal">
		...
		<div class="modal-content-item">
			...
			<form action="AdicionarItemController" method="post">
				...
				<input type="hidden" name="tipoItem" id="modalId" value=2>
				...
				<div class="form-group row">
					<label class="col-sm-3 col-form-label" for="modalFrequencia">Frequência</label>
					<div class="col-sm-7">
