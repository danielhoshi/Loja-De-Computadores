		...
		<div class="row" style="height: 700px">
			<div class="col-sm-9" id="tipos">
				<div class="row" style="margin: 50px">
					<span class="h1 text-warning" style="font-family: verdana">Placa-Mãe</span>
				...
				<a> 
					...
					class="col-sm-4 itemLista"> 
						...
						<span> Pentes de memória: <b><%=placa.getNumeroDePentes()%></b></span> <br> 
						<span> Preço: <b>R$<%=placa.getPrecoFormat()%></b></span>
					</span>
				</a>
				<%
						}
	...
	<div id="modalItem" class="modal">
		...
		<div class="modal-content-item">
			...
			<form action="AdicionarItemController" method="post">
				...
				<input type="hidden" name="tipoItem" value=1>
				...
				<div class="form-group row">
					<label class="col-sm-3 col-form-label" for="modalMemorias">Pentes de memória</label>
					<div class="col-sm-7">
