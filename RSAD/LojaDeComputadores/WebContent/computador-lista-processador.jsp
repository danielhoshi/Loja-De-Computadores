		...
		<div class="row" style="height: 700px">
			<div class="col-sm-9" id="tipos">
				<div class="row" style="margin: 50px">
					<span class="h1" style="font-family: verdana">Processador</span>
				...
				<%
					ArrayList<Processador> listaProcessador = (ArrayList<Processador>) request.getAttribute("listaProcessador");
					if(listaProcessador == null){
						%>
						<span style="font-family: verdana">Não foram encontrados processadores</span>
						<%
					}
					else{ 
						for (Processador processador : listaProcessador) {
				%>
				<a href="ComputadorProcessadorController?idPlaca=<%=request.getParameter("idPlaca")%>&idProcessador=<%=processador.getId()%>"> 
					<span class="col-sm-4 itemLista"> 
						...
						<span> Frequência: <b><%=processador.getFrequencia()%></b></span> <br> 
						<span> Soquete <b><%=processador.getSoquete().getNome()%></b></span> <br> 
						<span> Preço: <b>R$<%=processador.getPrecoFormat()%></b></span>
					</span>
				</a>
				<%
						}
